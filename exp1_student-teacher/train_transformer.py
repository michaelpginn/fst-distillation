...
if __name__ == "__main__":
    train_transformer(
        train_path="./data/task0-data/DEVELOPMENT-LANGUAGES/austronesian/hil.trn",
        eval_path="./data/task0-data/DEVELOPMENT-LANGUAGES/austronesian/hil.dev",
        test_path="./data/task0-data/GOLD-TEST/hil.tst",
        epochs=60,
    )
